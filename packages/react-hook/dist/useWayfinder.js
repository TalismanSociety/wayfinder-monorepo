...
var wayfinderInstance = new wayfinder_lib_1.default({ uri: 'http://localhost:4350/graphql' });
var useWayfinder = function (props) {
    if (props === void 0) { props = {}; }
    var availableAssets = props.availableAssets, autoSelectValues = props.autoSelectValues;
    var _a = (0, react_1.useState)(wayfinder_lib_1.defaultWayfinderCallbackResult), wayfinderState = _a[0], setWayfinderState = _a[1];
    (0, react_1.useEffect)(function () {
        wayfinderInstance.configure({ availableAssets: availableAssets, autoSelectValues: autoSelectValues });
    }, [availableAssets]);
    (0, react_1.useEffect)(function () {
