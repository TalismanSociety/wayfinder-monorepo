...
export const filterChannelDataByAssets = (result: QueryResultGroupType, assets: AvailableAsset[]|undefined) => {  

  /*
    1. --> init a return object
  */
  let filtered: QueryResultGroupType = defaultResultGroup


  /*
    2. --> if there's not assets return default result, or the empty filtered set
  */
  if(!assets) return result||filtered
