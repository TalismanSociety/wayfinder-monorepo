...
const projectName = process.env.PROJECT_NAME || 'wayfinder-datasource'
const githubUrl = process.env.GITHUB_URL || 'https://github.com/TalismanSociety/xcm-monorepo.git#main'
