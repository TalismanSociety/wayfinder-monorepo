...
export const chainTokens: RawData['chainTokens'] = [
  { chain: 'shiden', token: 'SDN', isNative: true, existentialDeposit: '1000000', tokenIdent: '' },
  { chain: 'shiden', token: 'KUSD', isNative: false, existentialDeposit: '1', tokenIdent: '18446744073709551616' },
]
