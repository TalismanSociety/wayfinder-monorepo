...
export const chainTokens: RawData['chainTokens'] = [
  { chain: 'pichiu', token: 'PCHU', isNative: false, existentialDeposit: '1000000000000', tokenIdent: 'PCHU' },
  { chain: 'pichiu', token: 'KAR', isNative: false, existentialDeposit: '100000000000', tokenIdent: 'KAR' },
  { chain: 'pichiu', token: 'KUSD', isNative: false, existentialDeposit: '10000000000', tokenIdent: 'KUSD' },
  { chain: 'pichiu', token: 'LKSM', isNative: false, existentialDeposit: '500000000', tokenIdent: 'LKSM' },
]
