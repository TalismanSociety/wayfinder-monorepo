...
export const rawData: RawData = {
  ...
  tokens: {
    ...
    CRAB: { name: 'CRAB', symbol: 'CRAB', decimals: 18, logo: githubChainLogoUrl('crab-kusama') },
    CSM: { name: 'CSM', symbol: 'CSM', decimals: 12, logo: githubChainLogoUrl('shadow-kusama') },
    ...
    HKO: { name: 'HKO', symbol: 'HKO', decimals: 12, logo: githubChainLogoUrl('heiko-kusama') },
    IBTC: { name: 'IBTC', symbol: 'IBTC', decimals: 8 },
    INTR: { name: 'INTR', symbol: 'INTR', decimals: 10, logo: githubChainLogoUrl('interlay') },
    KAR: { name: 'KAR', symbol: 'KAR', decimals: 12, logo: githubChainLogoUrl('karura') },
    KBTC: { name: 'KBTC', symbol: 'KBTC', decimals: 8 },
    KICO: { name: 'KICO', symbol: 'KICO', decimals: 14, logo: githubChainLogoUrl('kico') },
    KINT: { name: 'KINT', symbol: 'KINT', decimals: 12, logo: githubChainLogoUrl('kintsugi') },
    KMA: { name: 'KMA', symbol: 'KMA', decimals: 12, logo: githubChainLogoUrl('kintsugi') },
    KSM: { name: 'KSM', symbol: 'KSM', decimals: 12, logo: githubChainLogoUrl('calamari') },
    KUSD: { name: 'AUSD', symbol: 'AUSD', decimals: 12, logo: githubTokenLogoUrl('acala-substrate-tokens-ausd') },
    LDOT: { name: 'LDOT', symbol: 'LDOT', decimals: 10, logo: githubTokenLogoUrl('acala-substrate-tokens-ldot') },
    ...
    PARA: { name: 'PARA', symbol: 'PARA', decimals: 12, logo: githubChainLogoUrl('parallel') },
    PCHU: { name: 'PCHU', symbol: 'PCHU', decimals: 18, logo: githubChainLogoUrl('pichiu') },
    PHA: { name: 'PHA', symbol: 'PHA', decimals: 12, logo: githubChainLogoUrl('phala') },
    QTZ: { name: 'QTZ', symbol: 'QTZ', decimals: 18, logo: githubChainLogoUrl('quartz') },
    RMRK: { name: 'RMRK', symbol: 'RMRK', decimals: 10, logo: githubTokenLogoUrl('statemine-substrate-assets-rmrk') },
    SDN: { name: 'SDN', symbol: 'SDN', decimals: 18, logo: githubChainLogoUrl('shiden') },
    TEER: { name: 'TEER', symbol: 'TEER', decimals: 12 },
    TUR: { name: 'TUR', symbol: 'TUR', decimals: 10, logo: githubChainLogoUrl('turing') },
    USDT: { name: 'USDT', symbol: 'USDT', decimals: 8 },
    VSKSM: {
      name: 'VSKSM',
      symbol: 'VSKSM',
      decimals: 12,
      logo: githubTokenLogoUrl('bifrost-kusama-substrate-tokens-vsksm'),
    },
  },
