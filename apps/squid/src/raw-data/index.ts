...
export const rawData: RawData = {
  ...
  tokens: {
    ...
    AIR: { name: 'AIR', symbol: 'AIR', decimals: 18 },
    ARIS: { name: 'ARIS', symbol: 'ARIS', decimals: 8 },
    ASTR: { name: 'ASTR', symbol: 'ASTR', decimals: 18 },
    AUSD: { name: 'AUSD', symbol: 'AUSD', decimals: 12 },
    BNC: { name: 'BNC', symbol: 'BNC', decimals: 12 },
    BSX: { name: 'BSX', symbol: 'BSX', decimals: 12 },
    CRAB: { name: 'CRAB', symbol: 'CRAB', decimals: 18 },
    CSM: { name: 'CSM', symbol: 'CSM', decimals: 12 },
    DOT: { name: 'DOT', symbol: 'DOT', decimals: 10 },
    GLMR: { name: 'GLMR', symbol: 'GLMR', decimals: 18 },
    ...
    MOVR: { name: 'MOVR', symbol: 'MOVR', decimals: 18 },
