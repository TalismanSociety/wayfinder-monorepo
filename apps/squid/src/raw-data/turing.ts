...
export const chainTokens: RawData['chainTokens'] = [
  { chain: 'turing', token: 'TUR', isNative: true, existentialDeposit: '100000000', tokenIdent: 'TUR' },
  { chain: 'turing', token: 'KAR', isNative: false, existentialDeposit: '100000000000', tokenIdent: 'KAR' },
  // TODO: Double check that this shouldn't be `tokenIdent: 'KUSD'`
  { chain: 'turing', token: 'KUSD', isNative: false, existentialDeposit: '10000000000', tokenIdent: 'AUSD' },
  { chain: 'turing', token: 'LKSM', isNative: false, existentialDeposit: '500000000', tokenIdent: 'LKSM' },
]
