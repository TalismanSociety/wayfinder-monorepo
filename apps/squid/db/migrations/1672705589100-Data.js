module.exports = class Data1672705589100 {
  name = 'Data1672705589100'
  ...
  async up(db) {
    ...
    await db.query(
      `CREATE TABLE "chain_token" ("id" character varying NOT NULL, "is_native" boolean NOT NULL, "existential_deposit" text NOT NULL, "token_ident" text NOT NULL, "chaindata_id" text NOT NULL, "chain_id" character varying, "token_id" character varying, CONSTRAINT "PK_dc45f4dc156be196c13257cc4e0" PRIMARY KEY ("id"))`
    )
